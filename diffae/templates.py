...
def luna16_autoenc():
    conf = autoenc_base()
    conf.data_name = 'luna16'
    conf.warmup = 0
    conf.total_samples = 1139
    conf.net_ch_mult = (1, 2, 4, 8)
    conf.net_enc_channel_mult = (1, 2, 4, 8, 8)
    conf.eval_every_samples = 50000
    conf.eval_ema_every_samples = 50000
    conf.name = 'luna16_autoenc'
    # conf.eval_path = '/home/user/data/prior_train/gt'
